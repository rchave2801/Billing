...
CREATE TABLE `BILL` (
  ...
  `TOTAL_PRICE` bigint(20) NOT NULL COMMENT 'Bill total value',
  `STATUS` varchar(2) COLLATE latin1_spanish_ci NOT NULL DEFAULT 'PE' COMMENT 'Bill status',
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci COMMENT='Bill data';
...
--
-- Dumping data for table `BILL_HAS_SERVICES`
--

LOCK TABLES `BILL_HAS_SERVICES` WRITE;
/*!40000 ALTER TABLE `BILL_HAS_SERVICES` DISABLE KEYS */;
/*!40000 ALTER TABLE `BILL_HAS_SERVICES` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `SERVICE` (
  ...
  `DESCRIPTION` int(250) DEFAULT NULL COMMENT 'Service description',
  PRIMARY KEY (`CODE`),
  UNIQUE KEY `NAME` (`NAME`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci COMMENT='Service data';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `STATUS` (
  `CODE` varchar(2) COLLATE latin1_spanish_ci NOT NULL COMMENT 'Status id',
...
-- Dump completed on 2018-09-08 22:04:32
